...
// src/types.ts
var ChainIds = /* @__PURE__ */ ((ChainIds2) => {
  ChainIds2[ChainIds2["ethereum"] = 1] = "ethereum";
  ChainIds2[ChainIds2["optimism"] = 10] = "optimism";
  ChainIds2[ChainIds2["binance"] = 56] = "binance";
  ChainIds2[ChainIds2["gnosis"] = 100] = "gnosis";
  ChainIds2[ChainIds2["polygon"] = 137] = "polygon";
  ChainIds2[ChainIds2["sonic"] = 146] = "sonic";
  ChainIds2[ChainIds2["zksync"] = 324] = "zksync";
  ChainIds2[ChainIds2["base"] = 8453] = "base";
  ChainIds2[ChainIds2["arbitrum"] = 42161] = "arbitrum";
  ChainIds2[ChainIds2["avalanche"] = 43114] = "avalanche";
  ChainIds2[ChainIds2["linea"] = 59144] = "linea";
  ChainIds2[ChainIds2["berachain"] = 80094] = "berachain";
  return ChainIds2;
})(ChainIds || {});
...
var getWalletClient = (chainId) => {
  ...
  const privateKey = pkEnv.startsWith("0x") ? pkEnv : `0x${pkEnv}`;
...
// src/constants.ts
var ENSO_SUPPORTED_CHAINS = new Set(Object.values(ChainIds));
var ENSO_ETH = "0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee";
var CHAIN_EXPLORERS = {
  [1 /* ethereum */]: "https://etherscan.io",
  [10 /* optimism */]: "https://optimistic.etherscan.io",
  [56 /* binance */]: "https://bscscan.com",
  [100 /* gnosis */]: "https://gnosisscan.io",
  [137 /* polygon */]: "https://polygonscan.com",
  [146 /* sonic */]: "https://sonicscan.org",
  [324 /* zksync */]: "https://era.zksync.network",
  ...
  [80094 /* berachain */]: "https://berascan.com"
};
var MIN_ERC20_ABI = [
  {
    constant: false,
...
var routeAction = {
  ...
  validate: async (runtime) => {
    return !!runtime.getSetting("WALLET_PRIVATE_KEY") && !!runtime.getSetting("ENSO_API_KEY");
  },
  handler: async (runtime, message, state, options, callback) => {
    const supportedChains = Object.keys(ChainIds).map((c) => c.toLowerCase()).join(" | ");
    const currentState = !state ? await runtime.composeState(message, { supportedChains }) : await runtime.updateRecentMessageState(state);
    ...
    elizaLogger.info(content.object);
    ...
    if (tokenIn.toLowerCase() !== ENSO_ETH) {
        ...
        const txHash2 = await client.writeContract(request);
        const receipt2 = await client.waitForTransactionReceipt({
        hash: txHash2
        });
        if (receipt2.status !== "success") {
        callback({
            text: `\u274C Approval failed! Tx: ${txHash2}`,
            content: { hash: txHash2, status: "failed" }
        });
        return;
        }
        callback({
        text: `\u2705 Approval succeeded, going to continue with route execution! Tx: ${txHash2}`,
        content: { hash: txHash2, status: "success" }
        });
    }
...
var isEnsoRouteContent = (object) => {
  return EnsoRouteSchema.safeParse(object).success;
};
var getMissingEnsoRouteContent = (content) => {
  const missingFields = [];
